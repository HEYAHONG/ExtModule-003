...
then
	...
	rsync -rl --progress --delete --exclude='.git' --exclude='*.png' --exclude='*.jpg'  --exclude="hcppbox" --exclude="hrc"  --exclude="doc" --exclude="test" --exclude="*.md"  "${script_dir}/HCppBox/" "${script_dir}/master/"
fi 
